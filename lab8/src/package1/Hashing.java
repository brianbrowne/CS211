...
public class Hashing 
{
    ...
    {
      File testFile = new File("C:\\User\\dictionary.txt");     //this is where the file to be sorted is loaded from
     ...
     public static int getHashKey(String word)
     {
    	 ...
    	 {
    		 total = total + modMult((int)word.charAt(i), modPow(256,i, size), size);
    	 }
    	 return total%size;
