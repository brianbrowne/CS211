...
public class GalW extends Activity {
	
	Button sendEmail1;
	Button openWebsiteNoeGre;
	EditText Sub1;
	EditText msg1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gal_w);
		// Show the Up button in the action bar.
		
		sendEmail1=(Button)findViewById(R.id.sendEmailNoeGre);
		sendEmail1.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v)
			{
				Sub1=(EditText)findViewById(R.id.SubjectNoeGre);
				String SubjectJimDal=Sub1.getText().toString();
				msg1=(EditText)findViewById(R.id.messageNoeGre);
			...
			{
				String [] to=new String [] {"noel.grealish@oireachtas.ie"};
		...
		openWebsiteCiaCan.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v)
			{
				Intent WebsiteJoeCar=new Intent(Intent.ACTION_VIEW,Uri.parse("finegael.ie/our-people/ministers/ciaran-cannon"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gal_w, menu);
		return true;
	}
