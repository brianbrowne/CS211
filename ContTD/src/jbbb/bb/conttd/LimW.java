...
public class LimW extends Activity {
	
	Button sendEmail1;
	Button openWebsiteJanSul;
	EditText Sub1;
	EditText msg1;
	
	Button sendEmail2;
	Button openWebsiteKieDon;
	EditText Sub2;
	EditText msg2;
	
	Button sendEmail3;
	Button openWebsiteMicNoo;
	EditText Sub3;
	EditText msg3;
	
	Button sendEmail4;
	Button openWebsiteWilDea;
	EditText Sub4;
	EditText msg4;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lim_w);
		// Show the Up button in the action bar.
		
		sendEmail1=(Button)findViewById(R.id.sendEmailJanSul);
		sendEmail1.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v)
			{
				Sub1=(EditText)findViewById(R.id.SubjectJanSul);
				String SubjectJimDal=Sub1.getText().toString();
				msg1=(EditText)findViewById(R.id.messageJanSul);
			...
			{
				String [] to=new String [] {"jan.osullivan@oireachtas.ie"};
		...
		sendEmail2=(Button)findViewById(R.id.sendEmailKieDon);
		sendEmail2.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v)
			{
				Sub2=(EditText)findViewById(R.id.SubjectKieDon);
				String SubjectJimDal=Sub2.getText().toString();
				msg2=(EditText)findViewById(R.id.messageKieDon);
			...
			private void sendEmail1(String subject1, String msg1) 
			{
				String [] to=new String [] {"kieran.odonnell@oir.ie"};
				Intent emailIntent =new Intent(Intent.ACTION_SEND);
				emailIntent.putExtra(Intent.EXTRA_EMAIL,to);
				emailIntent.putExtra(Intent.EXTRA_SUBJECT,subject1);
				emailIntent.putExtra(Intent.EXTRA_TEXT,msg1);
		...
		openWebsiteChaFla.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v)
			{
				Intent WebsiteJoeCar=new Intent(Intent.ACTION_VIEW,Uri.parse("finegael.ie/our-people/tds/charles-flanagan/index.xml"));
				startActivity(WebsiteJoeCar);
			}
			});*/
		
		
		sendEmail3=(Button)findViewById(R.id.sendEmailMicNoo);
		sendEmail3.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v)
			{
				Sub3=(EditText)findViewById(R.id.SubjectMicNoo);
				String SubjectJimDal=Sub3.getText().toString();
				msg3=(EditText)findViewById(R.id.messageMicNoo);
			...
			private void sendEmail1(String subject1, String msg1) 
			{
				String [] to=new String [] {"minister@finance.gov.ie"};
				Intent emailIntent =new Intent(Intent.ACTION_SEND);
				emailIntent.putExtra(Intent.EXTRA_EMAIL,to);
				emailIntent.putExtra(Intent.EXTRA_SUBJECT,subject1);
				emailIntent.putExtra(Intent.EXTRA_TEXT,msg1);
		...
		sendEmail4=(Button)findViewById(R.id.sendEmailWilDea);
		sendEmail4.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v)
			{
				Sub4=(EditText)findViewById(R.id.SubjectWilDea);
				String SubjectJimDal=Sub4.getText().toString();
				msg4=(EditText)findViewById(R.id.messageWilDea);
			...
			private void sendEmail1(String subject1, String msg1) 
			{
				String [] to=new String [] {"willie.odea@oireachtas.ie"};
				Intent emailIntent =new Intent(Intent.ACTION_SEND);
				emailIntent.putExtra(Intent.EXTRA_EMAIL,to);
				emailIntent.putExtra(Intent.EXTRA_SUBJECT,subject1);
				emailIntent.putExtra(Intent.EXTRA_TEXT,msg1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lim_w, menu);
		return true;
	}
